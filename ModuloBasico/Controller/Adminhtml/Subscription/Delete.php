...
{
    /**
     * @var \Marcgento\ModuloBasico\Model\Subscription
     */
    ...
    public function __construct(
        Context $context,
        \Marcgento\ModuloBasico\Model\Subscription $subscriptionFactory
    ){
    ...
    {
        return $this->_authorization->isAllowed('Marcgento_ModuloBasico::subscription_delete');
    }
